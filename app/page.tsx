                ...
                <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
                    <div>
                        ...
                        <p className="mt-5 max-w-2xl leading-8 text-[var(--text-muted)]">
                            ...
                            , and
                            <span className="ml-1 font-semibold text-[var(--text)]">advanced</span>.
                        </p>

                        <p className="mt-4 max-w-2xl leading-8 text-[var(--text-muted)]">
                            Each level gives you 20 structured steps, which means 20 focused days of
                            action. Across 3 levels, that becomes a 60-day journey designed to help
                            one habit become part of your real life.
                        </p>
                        ...
                        <div className="mt-8 grid gap-4 sm:grid-cols-3">
                            ...
                            <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg)] p-4">
                                ...
                                <p className="mt-2 text-sm leading-6 text-[var(--text-muted)]">
                                    Make it part of your identity with stronger long-term
                                    consistency.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 flex flex-wrap gap-5 text-sm text-[var(--text-muted)]">
                            ...
                            <div className="flex items-center gap-2">
                                <Sparkles className="text-[var(--primary)]" size={16} />3 levels ×
                                20 steps
                            </div>
                        </div>
                    </div>
